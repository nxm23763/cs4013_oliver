...
class AudioRecorder:
    def __init__ (self, sample_rate=16000, channels=1, duration=4, wake_word = False, halt_word = False):
        ...
        print("Subscriber setup: "+ str(self.data.get_num_connections()) + " connections")
        rospy.sleep(1)  # Add a short delay to allow time for the subscriber to connect
        print("After delay:  "+ str(self.data.get_num_connections()) + " connections")
        ...
        with sr.WavFile("voice_in.wav") as source:                # use the default microphone as the audio source
            ...
            try:
                ...
                for prediction in list:
                    ...
                    if ("oliver") in str(self.user_question).lower():
                        print("works")
                        self.wake_word = True
